...
if MULAI_SCAN:
    with st.spinner("Memproses data..."):
        try:
            ...
            # Ambil data 1H untuk perhitungan MA konsisten
            ...
            for ticker in watchlist:
                ...
                ma10, ma20, ma50 = float(df_s['Close'].rolling(10).mean().iloc[-1]), float(df_s['Close'].rolling(20).mean().iloc[-1]), float(df_s['Close'].rolling(50).mean().iloc[-1])
